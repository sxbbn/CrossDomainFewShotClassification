...
def parse_args(script):
  ...
  parser.add_argument('--model', default='ResNet10', help='model: ') # we use ResNet10 in the paper
  parser.add_argument('--method', default='protonet',   help='')
  parser.add_argument('--train_n_way' , default=5, type=int,  help='class num to classify for training')
  parser.add_argument('--test_n_way'  , default=5, type=int,  help='class num to classify for testing (validation) ')
  parser.add_argument('--n_shot'      , default=5, type=int,  help='number of labeled pro_data in each class, same as n_support')
  parser.add_argument('--train_aug'   , action='store_true',  help='perform pro_data augmentation or not during training ')
  parser.add_argument('--name'        , default='resnet_protonet', type=str, help='')
  parser.add_argument('--save_dir'    , default='./outputs', type=str, help='')
