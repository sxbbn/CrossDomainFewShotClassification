import os
import random
from pro_data.datamgr import SetDataManager, SimpleDataManager
from utils.utils import *
from utils.options import parse_args, get_resume_file, load_warmup_state
...
if __name__=='__main__':
  ...
  aux_datamgr             = SimpleDataManager(image_size, batch_size=16)#batch_size = 16
